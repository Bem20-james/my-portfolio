  ...
  return (
    <>
      ...
      >
        <a href="#top">
          <Image
            src={isDarkMode ? assets.logo_dark : assets.logo_main}
            alt="Logo"
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href="#contact"
            className="hidden lg:flex items-center gap-3 px-10 py-2.5  t border border-gray-500 rounded-full ml-4 font-ovo hover:scale-105 transition-transform duration-300"
          >
            Connect{" "}
            <Image
        ...
        <ul
          ref={sideMenuRef}
          className="md:hidden flex flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transision duration-500 dark:bg-brand  dark:text-white"
        >
